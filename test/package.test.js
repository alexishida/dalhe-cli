...
test('npm pack includes package.json and skill templates', async () => {
  ...
  try {
    ...
    assert.match(output, /src\/template\/skills\/dl-rails-code-audit\/SKILL\.md/);
    assert.match(output, /src\/template\/skills\/dl-code-review\/SKILL\.md/);
    assert.match(output, /src\/template\/skills\/dl-nodejs-dev\/SKILL\.md/);
    assert.match(output, /src\/template\/skills\/dl-pure-ruby\/SKILL\.md/);
  } finally {
